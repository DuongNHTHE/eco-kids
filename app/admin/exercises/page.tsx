    ...
    return (
        <main className="min-h-screen">
            <header className="border-b border-[#dceadd] bg-white/80 backdrop-blur-sm">
                <div className="mx-auto max-w-7xl px-5 py-6 lg:px-10">
                    <Link
                        ...
                        className="text-sm font-bold text-[#6eaa83]"
                    >
                        ← Về dashboard
                    </Link>
                    ...
                    <div className="mt-4 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-[#71867c]">
                                Tạo bài phát âm và điền từ cho bé sau khi hoàn thành
                                chủ đề.
                            </p>
                        </div>
                    </div>
            ...
            <div className="mx-auto grid max-w-7xl gap-6 px-5 py-8 lg:grid-cols-[380px_1fr] lg:px-10">
                <form
                    onSubmit={submit}
                    className="h-fit rounded-[2rem] bg-white p-6 shadow-soft"
                >
                    ...
                    <label className="mt-4 block text-sm font-bold">
                        ...
                        <input
                            ...
                            placeholder="Ví dụ: Nói về khu rừng"
                            className="mt-2 w-full rounded-xl border border-[#dceadd] px-3 py-3 font-normal"
                        />
                    </label>
                        ...
                        <textarea
                            ...
                            placeholder={
                                form.type === "PRONUNCIATION"
                                    ? "Hãy đọc câu: The forest is green."
                                    : "Điền từ còn thiếu: The ___ is green."
                            }
                            rows={3}
                            className="mt-2 w-full resize-y rounded-xl border border-[#dceadd] px-3 py-3 font-normal"
                        />
                    </label>
                    ...
                    <label className="mt-4 block text-sm font-bold">
                        Gợi ý{" "}
                        <span className="font-normal text-[#83968c]">
                            (không bắt buộc)
                        </span>
                    ...
                    <button
                        disabled={saving}
                        className="mt-6 w-full rounded-full bg-[#f47d52] px-5 py-3 font-bold text-white disabled:opacity-60"
                    >
                        {saving ? "Đang lưu..." : "Thêm bài ôn luyện"}
                    </button>

                    {message && (
                        <p className="mt-3 text-sm font-bold text-[#2d6358]">
                            {message}
                        </p>
                    )}
                </form>
                ...
                <section>
                    <div className="mb-5 flex items-end justify-between gap-4">
                        ...
                        <span className="rounded-full bg-white px-4 py-2 text-sm font-bold text-[#71867c] shadow-sm">
                            {exercises.length} bài
                        </span>
                    </div>

                    {exercises.length === 0 ? (
                        <div className="rounded-[2rem] bg-white p-10 text-center text-[#71867c] shadow-soft">
                            Chưa có bài ôn luyện nào.
                        </div>
                    ) : (
                        <div className="space-y-3">
                            {exercises.map((exercise) => {
                                const topic = topics.find(
                                    (item) => item.id === exercise.topicId
                                );
                                    ...
                                    >
                                        <div className="flex flex-wrap items-start justify-between gap-3">
                                            ...
                                            <button
                                                ...
                                                className="font-bold text-[#d45e45]"
                                            >
                                                Xóa
                                            </button>
                                        </div>

                                        <p className="mt-4 rounded-xl bg-[#f4faf4] p-3 text-sm">
                                            {exercise.prompt}
                                        </p>

                                        <small className="mt-2 block font-bold text-[#83968c]">
